        ...
        const projects = work.map((project) => {
            return (
                <div key={project["title"]} className="projects-content-item">
                    ...
                    <a target="_blank" href={project["link"] ? project["link"] : project["github"]} rel="noopener noreferrer"><img alt={project["alt"]} src={"./images/"+project["img"]}></img></a>
                </div>
            )
        })
            ...
            <section id="projects" className="projects">
                <div className="projects-align">
                    <div className="projects-content">
                        ...
                        {this.state.showMore ? projects : projects.slice(0,3)}
