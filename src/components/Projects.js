...
class Projects extends React.Component {
    ...
    render() {
        const projects = [{
            ...
            "title":"Echo",
            "description":"I teamed up with some friends to create this 2D side scroller game concept using Unity. Although it didn't win any prizes/awards, this was my first hackathon and it was super enjoyable.",
            "tools":["Unity","C#"],
            "img":"echo.png",
            "alt":"echo",
                                ...
                                <div className="projects-content-item">
                                    <div className="projects-content-item-text">
                                        <div className="projects-content-item-text-purpose">
                                            <a target="_blank" href={project["purpose"]["link"]} rel="noopener noreferrer">
                                                <img alt={project["purpose"]["alt"]} src={"./images/"+project["purpose"]["img"]}></img><p>{project["purpose"]["title"]}</p>
                                            </a>
                                        </div>
