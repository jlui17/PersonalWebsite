  ...
  const experiences = jobs.map((job) => {
    return (
      <div
        ...
        className="experiences-content-item"
      >
        ...
        <div className="experiences-content-item-text">
          ...
          <div
            style={{ marginBottom: "var(--title-detail-spacing)" }}
            className="experiences-content-item-text-details"
          >
            <p>{job["company"]}</p>
            <p>{job["location"]}</p>
          </div>
          {job["description"].map((text) => {
            return (
              <p
                key={text}
                style={{
                  marginBottom: "var(--experiences-description-spacing)",
                }}
              >
                {text}
              </p>
